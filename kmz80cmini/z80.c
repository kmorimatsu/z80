...
/*
	...
	functions (see z80.h; setTx() functions depend upon the project).
*/

/*
	Available functions called from outside:
...
/*
	In z80peripheral.h, following functions/macros must be defined:
	UINT8 _getCode();
	...
	In z80peripheral.h, PRECODExx and POSTCODExx can be defined if required.
*/
...
/*
	Activate following line if _getCode() macro must be used everytime.
	This will speed up Z80 emulation but takes longer code area.
*/
...
/* Commonly used functions follow */
