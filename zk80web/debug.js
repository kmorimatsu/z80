...
function clickStopAt(val){
	if (val) {
		cpu.breakPoint=parseInt(val,16);
		if (cpu.step) {
			cpu.step=0;
			start();
		}
...
function debugDisplay(addr,data){
	...
	str+="("+("000"+cpu.regPC.toString(16)).substr(-4,4).toUpperCase()+") ";
...
function showRegisters(){
	var str="";
	str+="PC:"+("000"+cpu.regPC.toString(16)).substr(-4,4).toUpperCase()+" ";
	str+="AF:"+("000"+cpu.regAF.toString(16)).substr(-4,4).toUpperCase()+" ";
	str+="BC:"+("000"+cpu.regBC.toString(16)).substr(-4,4).toUpperCase()+" ";
	str+="DE:"+("000"+cpu.regDE.toString(16)).substr(-4,4).toUpperCase()+" ";
	str+="HL:"+("000"+cpu.regHL.toString(16)).substr(-4,4).toUpperCase();
	str+="<br />\r\n";
	str+="SP:"+("000"+cpu.regSP.toString(16)).substr(-4,4).toUpperCase()+" ";
	str+="IX:"+("000"+cpu.regIX.toString(16)).substr(-4,4).toUpperCase()+" ";
	str+="IY:"+("000"+cpu.regIY.toString(16)).substr(-4,4).toUpperCase()+" ";
	str+="SZ-H-PNC:"+cpu.flagS+cpu.flagZ+"-"+cpu.flagH+"-"+cpu.flagP+cpu.flagN+cpu.flagC+"<br />\r\n";
//	str+="A:"+("0"+cpu.regA.toString(16)).substr(-2,2).toUpperCase()+" ";
//	str+="F:"+("0"+cpu.regF.toString(16)).substr(-2,2).toUpperCase()+" ";
//	str+="B:"+("0"+cpu.regB.toString(16)).substr(-2,2).toUpperCase()+" ";
//	str+="C:"+("0"+cpu.regC.toString(16)).substr(-2,2).toUpperCase()+" ";
//	str+="D:"+("0"+cpu.regD.toString(16)).substr(-2,2).toUpperCase()+" ";
//	str+="E:"+("0"+cpu.regE.toString(16)).substr(-2,2).toUpperCase()+" ";
//	str+="H:"+("0"+cpu.regH.toString(16)).substr(-2,2).toUpperCase()+" ";
//	str+="L:"+("0"+cpu.regL.toString(16)).substr(-2,2).toUpperCase();
//	str+="<br />\r\n";
//	str+="IXh:"+("0"+cpu.regIXh.toString(16)).substr(-2,2).toUpperCase()+" ";
//	str+="IXl:"+("0"+cpu.regIXl.toString(16)).substr(-2,2).toUpperCase()+" ";
//	str+="IYh:"+("0"+cpu.regIYh.toString(16)).substr(-2,2).toUpperCase()+" ";
//	str+="IYl:"+("0"+cpu.regIYl.toString(16)).substr(-2,2).toUpperCase()+" ";
//	str+="SPh:"+("0"+cpu.regSPh.toString(16)).substr(-2,2).toUpperCase()+" ";
//	str+="SPl:"+("0"+cpu.regSPl.toString(16)).substr(-2,2).toUpperCase();
//	str+="<br />\r\n";
	str+="I:"+("0"+cpu.regI.toString(16)).substr(-2,2).toUpperCase()+" ";
	str+="R:"+("0"+cpu.regR.toString(16)).substr(-2,2).toUpperCase()+" ";
	str+="IFF1:"+cpu.flagIFF1+" ";
	str+="IFF2:"+cpu.flagIFF1+" ";
	str+="IM:"+("0"+cpu.regIM.toString(16)).substr(-2,2);
	str+="<br />\r\n";
	if (this.prevstr) {
		var str2="";
	...
	str+=this.prevcode=disasm1(cpu.regPC);
	debug(str);
}
	...
	if (cpu.regPC<0x1000) {
		...
		for (i=0;i<1048576;i++) {//*/
			if (logto) {
				...
				do {
					cpu.exec(1);
					log+=cpu.regPC.toString(16)+" "+disasm1(cpu.regPC)+"\r\n";
				} while (cpu.regPC!=logto);
				dom.displaylog(log);
				logto=0;
				break;
			} else {
